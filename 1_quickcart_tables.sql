...
[Gender] CHAR(1) CONSTRAINT ck_gender CHECK (gender IN ('F','M')) NOT NULL,
[DateofBirth] DATE CONSTRAINT ck_dob CHECK (dateofbirth <GETDATE()) NOT NULL,
...
[QuantityPurchased] SMALLINT CONSTRAINT ck_quantitypurchased CHECK(quantitypurchased >0) NOT NULL,
[DateOfPurchase] SMALLDATETIME CONSTRAINT ck_dateofpurchase CHECK(dateofpurchase <= getdate()) NOT NULL 
)
GO
ALTER TABLE PurchaseDetails ADD CONSTRAINT df_dop  DEFAULT GETDATE() FOR [DateOfPurchase]
